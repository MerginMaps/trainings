...
5. Click **Finish** to create the project.
  ...
  ![Create new Mergin Maps project in QGIS](../assets/Screenshot 2024-03-01 212429.png "Create new Mergin Maps project in QGIS")

Your new project should now be created and uploaded to [ Mergin Maps](https://merginmaps.com/) cloud. 
...
3. Add a **New Field** called `date` with the data type ***Date***
  ![New date field](../Assets/qgis-geopackage-date.jpg "New date field")
...
We will start with seting up the form for the `buildings` layer:
...
16. Set the form for the `floors` attribute as follows:
  - **Alias** to `Floors`
  - **Widget Type** to ***Range*** using a ***Slider***. Set **Minumum** to `1` and **Maximum** to `30`. Feel free to adjust the maximum to your needs. We'll use `1` for **Step**.
...
![HTML Map Tip](../Assets/Screenshot 2024-03-03 113406.png "HTML Map Tip")
...
2. **Save** the QGIS project
  ![Save QGIS project](../Assets/qgis-project-save.jpg "Save QGIS project")
