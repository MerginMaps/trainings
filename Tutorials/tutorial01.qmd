...
```
in your YAML because Quarto sets `number-sections: false` by default and that will mess up all your equation, figure and table numbers. 
It simple will not number them correctly at all.
